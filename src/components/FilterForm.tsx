  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row sm:flex-wrap sm:items-end gap-3">
      ...
      <input
        ...
        className="w-full sm:w-auto px-3 py-2 bg-zinc-800/70 rounded-md border border-zinc-700 text-white focus:ring-2 focus:ring-purple-400 focus:border-transparent transition"
      />
      <input
        name="endDate"
        type="date"
